...
const AnimatedButton = ({
  ...
  if (route) {
    // Check if route is external (starts with http:// or https://) or is an HTML file
    const isExternalLink = route.startsWith('http://') || route.startsWith('https://') || route.endsWith('.html');
